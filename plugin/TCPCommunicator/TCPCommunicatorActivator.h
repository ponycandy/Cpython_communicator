...
class TCPCommunicatorActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit TCPCommunicatorActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static TCPCommunicatorActivator *m_instance;
