#ifndef PYTHONCPPTCPPTEST_H
#define PYTHONCPPTCPPTEST_H
#ifndef QTPLUGIN_H
#define QTPLUGIN_H
...
class pythonCpptcpptestActivator : public QObject,public PluginInterface
{
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID PluginInterface_iid)
public:
    explicit pythonCpptcpptestActivator(QObject *parent = nullptr);
    void stop() override;
    void start() override;
...
private:
    static pythonCpptcpptestActivator *m_instance;
